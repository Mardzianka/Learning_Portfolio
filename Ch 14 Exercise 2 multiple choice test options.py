#Program name: Ch 14 Exercise 2 multiple choice test options.py
#displays menu of options for creating, amending and printing a multiple choice test
...
possibleAnswers = Text(frame_entry, width = 50,height = 10, bg = "white", \
                font = ('Arial', 11))
...
def editQuestions():
    ...
    print("Please do this in Notepad")
    root.destroy()

def printFile():
    print("Option 4 Print file chosen")
    print("Please do this in Notepad")
    root.destroy()
...
def getMenuChoice():
    ...
    while choice not in ["1","2","3","4","5"]:
        choice = input("Must be between 1 and 5")
    return choice    
...
print("\nMain menu")
print("1. Create a new test file")
print("2. Add questions to an existing test")
print("3. Edit questions in an existing test")
print("4. Print the contents of a test file")
print("5. Quit")                       
choice = getMenuChoice()
if choice == "1":
    createNewFile()
#run mainloop to draw the window to allow data entry
    root.mainloop()
elif choice == "2":
    addQuestions()
